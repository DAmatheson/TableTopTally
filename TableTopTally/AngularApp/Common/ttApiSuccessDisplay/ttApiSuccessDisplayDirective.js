...
ttDirectives.directive('ttApiSuccessDisplay', ['$timeout', '$interval', '$location', 'tempRedirectionData',
    function ($timeout, $interval, $location, tempRedirectionData)
    {
        ...
        return {
            ...
            templateUrl: 'AngularApp/Common/ttApiSuccessDisplay/ApiSuccessDisplay.html',
